...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "zen | stupidity at its best",
    description: `a full-time high school student and most-of-the-time-if-im-free developer from the United States with experience in programming since 2018.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://zsld.spae${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://zsld.space${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="zslddd" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="zslddd" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">zsld</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} zslddd. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
