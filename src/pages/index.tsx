...
const aboutStats = [
  ...
  { label: "People and companies I worked with", value: "4+" },
];
...
const services = [
  {
    service: "Minecraft Development",
    description:
      "Modifying and developing with Minecraft since 2018.",
    icon: Code2,
  },
  {
    service: "UX Design",
        ...
        <section id="projects" data-scroll-section>
          ...
          <div data-scroll data-scroll-speed=".4" className="my-64">
            ...
            <p className="mt-1.5 text-base tracking-tight text-muted-foreground xl:text-lg">
              I&apos;ve worked on a variety of projects, from Minecraft clients to
